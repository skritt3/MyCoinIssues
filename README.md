...
### Пример отчета (Я забыл VK ID, но вы пишите):
...
- [x] Реализация базового дизайна (11.04.19)
- [x] Реализация разделов (12.04.19)
- [x] Реализация связи с БД (15.04.19)
- [x] Реализация блокировок (15.04.19)
- [x] Реализация общего топа (17.04.19)
- [x] Реализация топа друзей (19.04.19)
